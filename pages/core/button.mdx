...
| appearance   | `default`, `primary`, `danger`, `warning`, `success`, `subtle`, `link`, `help`, `clean` | "default" | applied style of button                                              |
| type         | string                                                                                  | button    | button type attribute                                                |
| size         | `sm`, `md`,`lg`                                                                         | "md"      | button size style                                                    |
| fluid        | boolean                                                                                 |           | full width style button                                              |
| iconBefore   | string                                                                                  |           | icon before text name                                                |
| iconAfter    | string                                                                                  |           | icon after text name                                                 |
| iconOnly     | boolean                                                                                 |           |                                                                      |
| form         | string                                                                                  |           | Name property of a linked form that the button submits when clicked. |
| isLoading    | boolean                                                                                 |           |                                                                      |
| isDisabled   | boolean                                                                                 |           |                                                                      |
| isSelected   | boolean                                                                                 |           |                                                                      |
| href         | string                                                                                  |           |                                                                      |
| target       | string                                                                                  |           |                                                                      |
| autoFocus    | boolean                                                                                 |           |                                                                      |
| onClick      | `(e: React.SyntheticEvent<HTMLElement>) => void`                                        |           | click on button event                                                |
| tabIndex     | number                                                                                  |           | aria tabindex attribute                                              |
